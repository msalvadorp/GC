...
namespace ClienteMVC.Controllers
{
    public class OrdenPagoController : Controller
    {
        ...
        private void LlenarViewBag()
        {
            ...
            Tipo tipoTodos = new Tipo();
            tipoTodos.IdTipo = 0;
            tipoTodos.Nombre = "<< TODOS >>";
            parametro[EnumTipos.TipoMoneda].Insert(0, tipoTodos);
            parametro[EnumTipos.TipoSituacionOrdenPago].Insert(0, tipoTodos);
